                ...
                command: function () {
                    if (host.linux || host.mac) {
                        return [
                            ...
                            'cp -r src node_modules .git.json CHANGELOG.md LICENSE.txt package.json README.md build/releases/Popcorn-Time/linux64/Popcorn-Time',
                ...
                command: function () {
                    if (host.linux || host.mac) {
                        return [
                            ...
                            'cp -r src node_modules .git.json CHANGELOG.md LICENSE.txt package.json README.md build/releases/Popcorn-Time/linux32/Popcorn-Time',
