...
##
## Usage
## ./make_popcorn_time.sh [url]
##
## The script make_popcorn_time.sh allows you to clone, setup, and build a version of Popcorn Time
...
## ./make_popcorn_time.sh '-b release/0.3.4 https://github.com/popcorn-official/popcorn-desktop'
##
...
if [ "$clone_repo" = "True" ]; then
    ...
    read -p "Where do you wish to clone Popcorn Time to? [popcorn-time] " dir
    if [ -z "$dir" ]; then
        dir='popcorn-time'
    elif [ "$dir" = "/" ]; then
        dir='popcorn-time'
