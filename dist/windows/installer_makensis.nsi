...
LangString noRoot ${LANG_Afrikaans} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Albanian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Arabic} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Asturian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Basque} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Belarusian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Bosnian} "You cannot install Popcorn Time in a directory that requires administrator permissions" 
LangString noRoot ${LANG_Breton} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Bulgarian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Catalan} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Croatian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Czech} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Danish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Dutch} "Popcorn Time kan niet worden geïnstalleerd in een map die beheerdersrechten vereist"
LangString noRoot ${LANG_Esperanto} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Estonian} "You cannot install Popcorn Time in a directory that requires administrator permissions" 
LangString noRoot ${LANG_Farsi} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Finnish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_French} "Popcorn Time ne peut être installé dans un répertoire nécessitant un accès administrateur"
LangString noRoot ${LANG_Galician} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_German} "You cannot install Popcorn Time in a directory that requires administrator permissions" 
LangString noRoot ${LANG_Greek} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Hebrew} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Hungarian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Icelandic} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Indonesian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Irish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Italian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Japanese} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Korean} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Kurdish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Latvian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Lithuanian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Luxembourgish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Macedonian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Malay} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Mongolian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Norwegian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_NorwegianNynorsk} "You cannot install Popcorn Time in a directory that requires administrator permissions" 
LangString noRoot ${LANG_Pashto} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Polish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Portuguese} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_PortugueseBR} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Romanian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Russian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Serbian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_SerbianLatin} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_SimpChinese} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Slovak} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Slovenian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Spanish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_SpanishInternational} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Swedish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Thai} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_TradChinese} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Turkish} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Ukrainian} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Uzbek} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Vietnamese} "You cannot install Popcorn Time in a directory that requires administrator permissions"
LangString noRoot ${LANG_Welsh} "You cannot install Popcorn Time in a directory that requires administrator permissions"
