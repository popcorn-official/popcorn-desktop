        ...
        showPlayerList: function(e) {
            if (e.button === 2) {
                App.vent.trigger('notification:show', new App.Model.Notification({
                    title: '',
                    body: i18n.__('Popcorn Time currently supports') + '<br>VLC, Fleex player, MPlayer, MPlayerX, MPlayer OSX Ext., IINA, mpv, mpv.net, MPC-HC, MPC-BE, SMPlayer, PotPlayer, Bomi & BSPlayer.<br><br>' + i18n.__('There is also support for Chromecast, AirPlay & DLNA devices.'),e,
                    type: 'success'
                }));
            }
        },
