(function(App) {
  ...
  App.View.MovieDetail = Marionette.View.extend({
    ...
    initialize: function() {
      ...
      //Check for missing metadata or if Translate Synopsis is enabled and the language set to something other than English and if one, or multiple are true run the corresponding function to fetch them
