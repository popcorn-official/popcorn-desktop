        ...
        pack.extractAllToAsync(extractDir, true, function (err) {
            if (err) {
                ...
                App.vent.trigger('notification:show', new App.Model.Notification({
                    ...
                    body: (updateData.description + '<p style="font-size:75%;opacity:0.75">* ' + i18n.__('Remember to Export your Database before updating in case its needed to restore your Favorites, marked as watched or settings') + '</font>' || 'Auto update'),
                    showRestart: false,
                    type: 'info',
                    buttons: [
