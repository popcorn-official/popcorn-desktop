<ul class="nav nav-hor left">
    ...
    <li class="source <%= tab.type %>TabShow providerinfo" title="<%= App.Config.getFiltredProviderNames(tab.type) %>"><%= i18n.__(tab.name) %></li>
    <% }); %>
    <li id="filterbar-favorites" class="source providerinfo" data-toggle="tooltip" title="<%= i18n.__("Favorites") %>"><%= i18n.__("Favorites") %></li>
</ul>
