<table>
    ...
    <tr data-key="<%=k %>">
        ...
        <td class="ellipsis item-play"><span title="<%=torrent.title %>" class="tooltipped" data-toggle="tooltip" data-container="body" data-placement="top"><%=torrent.title %></span></td>
