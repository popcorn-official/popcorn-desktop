<table>
    ...
    <tr class="item-row" data-key="<%=k %>">
        ...
        <td class="ellipsis item-play<%= Settings.seriesUITransparency ? '' : ' transpOff' %>"><span title="<%=torrent.title %>" class="item-play tooltipped" data-toggle="tooltip" data-container="body" data-placement="top"><%=torrent.title %></span></td>
