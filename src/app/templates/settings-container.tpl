<div class="settings-container">
	...
	<div class="content">
		...
		<div class="advanced-settings">
			...
			<input type="text" placeholder="<%= i18n.__("Cache Directory") %>" id="faketmpLocation" value="<%= Settings.tmpLocation %>" readonly="readonly" size="75" /> <i class="open-tmp-folder fa fa-folder-open-o"></i>
