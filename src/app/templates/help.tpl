	...
	<div class="content">
		...
		<div class="help-outer">
			...
			<p>With Popcorn Time, you can watch Movies and TV Series really easely. All you have to do is click on one of the covers, then click "Watch Now". But your experience is highly customizable:
				<ul>
					<li><b><%= i18n.__("Movies") %>:</b> Our Movies collection only contains High-Definition movies, available in 720p and 1080p. To watch a movie, simply open Popcorn Time and navigate through the movies collection, reacheable through the "Movies" tab, in the navigation bar. The default view will show you all movies sorted by popularity, but you can apply your own filters, thanks to the "Genre" and "Sort by" filters. Once you have chosen a movie you want to watch, click its cover. Then click "Watch Now". Don't forget the popcorn!</li>
					<li><b><%= i18n.__("TV Series") %>:</b> The TV Series tab, that you can reach by clicking "TV Series" in the navigation bar, will show you all available series in our collection. You can also apply your own filters, same as the Movies, to help you decide what to watch. In this collection, also just click the cover: the new window that will appear will allow you to navigate through Seasons and Episodes. Once your mind is set, just click the "Watch Now" button.</li>
					<li><b><%= i18n.__("Choose quality") %>:</b> A slider next to the "Watch Now" button will let you choose the quality of the stream. You can also set a fixed quality in the Settings tab. Warning: a better quality equals more data to download.</li>
					<li><b><%= i18n.__("Subtitles") %>:</b> Most of our Movies and TV Series have subtitles in your language. You can set them in the Settings tab. For the Movies, you can even set them through the dropdown menu, in the Movie Details page.</li>
					<li><b><%= i18n.__("Favorites") %>:</b> Clicking the heart icon on a cover will add the movie/show to your favorites. This collection is reacheable through the heart-shaped icon, in the navigation bar. To remove an item from your collection, just click on the icon again! How simple is that?</li>
					<li><b><%= i18n.__("Watched icon") %>:</b> Popcorn Time will keep in mind what you've already watched - a little help remembering doesn't cause any harm. You can also set an item as watched by clicking the eye-shaped icon on the covers. You can even build and syncronize your collection with Trakt.tv website, every required step will be described below.</li>
					...
					<li><b><%= i18n.__("External Players") %>:</b> If you prefer to use a custom player instead of the builtin one, you can do so by clicking the allocated icon on the "Watch Now" button. A list of your installed players will be shown, select one and Popcorn Time will send everything to it. If your player isn't on the list, please report it to us.</li>
					<li><b><%= i18n.__("Settings") %>:</b> To push the customization even further, we offer you a large panel of options. To access the Settings, click the nut-shaped icon in the navigation bar.</li>
					<li><b><%= i18n.__("Keyboard Navigation") %>:</b> The entire list of keyboard shortcuts is available by pressing "?" on your keyboard, or through the keyboard-shaped icon in the Settings tab.</li>
					<li><b><%= i18n.__("Custom Torrents and Magnet Links") %>:</b> You can use custom torrents and magnets links in Popcorn Time. Simple drag and drop .torrent files into the application's window, and/or paste any magnet link.</li>
					<li><b><%= i18n.__("Torrent health") %>:</b> On the details of Movies/TV Series, you can find a little circle, colored in grey, red, yellow or green. Those colors refer to the health of the torrent. A green torrent will be downloaded quickly, while a red torrent may not be downloaded at all, or very slowly. The color grey represents an error in the health calculation for Movies, and needs to be clicked in TV Series in order to display the health.</li>
				</ul>
			</p>
			...
			<h2>I found a bug, how do I report it? <em>[English only]</em></h2>
